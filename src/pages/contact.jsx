...
//       <label
//         htmlFor={name}
//         className={`block text-xs tracking-[0.15em] mb-3 transition-colors duration-300 ${
//           focused ? "text-[var(--gold,#b8934a)]" : "text-black/40"
//         }`}
//       >
//         {label.toUpperCase()}
//       </label>
...
//         className="w-full bg-transparent text-black text-sm md:text-base placeholder-black/25 outline-none pb-3 resize-none"
//       />
...
//   return (
//     <section id="contact" className="relative bg-[#f7f4f1] py-20 md:py-28 px-6 md:px-16">
//       <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-10">

//         {/* Left — heading */}
//         <div>
//           <p className="text-xs tracking-[0.25em] text-sky-600 mb-4">WRITE US</p>
//           <h2 className="font-[var(--font-heading)] text-black text-3xl sm:text-4xl md:text-5xl leading-tight">
//             GREAT INTERIORS
//             <br />
//             <span className="block ml-6 sm:ml-10 md:ml-14">BEGINS WITH A</span>
//             <span className="block ml-10 sm:ml-16 md:ml-24">CONVERSATION</span>
//           </h2>
//         </div>
...
//                   className="flex items-center gap-1.5 pb-3 text-black"
//                 >
//                   <span className="text-lg leading-none">{country.flag}</span>
//                   <ChevronDown
//                     size={14}
//                     className={`text-black/50 transition-transform duration-300 ${
...
//               <span className="pb-3 text-black/60 text-sm md:text-base">
//                 {country.code}
//               </span>
...
//                 className="flex-1 bg-transparent text-black text-sm md:text-base placeholder-black/25 outline-none pb-3"
//               />
//             </div>
